...
export function KaiPersonaScreen(props: {
  ...
  return (
    <main className="min-h-[100dvh] w-full bg-transparent flex flex-col overflow-y-auto overscroll-y-contain px-8 pt-[calc(12px+env(safe-area-inset-top))] pb-[var(--app-screen-footer-pad)]">
