...
async def test_request_context_middleware_db_validation():
    ...
    with patch("hushh_mcp.consent.token.validate_token_with_db", new_callable=AsyncMock) as mock_validate:
